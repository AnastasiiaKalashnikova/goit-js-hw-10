...
(function(e){let t=e.map(({id:e,name:t})=>`<option value=" ${e}"> ${t} </option>`).join("");s.insertAdjacentHTML("beforeend",t)})(e)}).catch(e=>console.log(e));//# sourceMappingURL=index.0ef37063.js.map

//# sourceMappingURL=index.0ef37063.js.map
